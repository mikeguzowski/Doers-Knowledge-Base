Obsidian is similar to plain-text based note-taking apps in the sense that [[Obsidian 101/Adventurer/Vault is just a local folder|a vault is just a local folder]].
